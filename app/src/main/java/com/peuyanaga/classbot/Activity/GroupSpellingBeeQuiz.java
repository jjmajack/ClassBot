...
public class GroupSpellingBeeQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Server server : global.getServerList()){
            if (server.getName().equalsIgnoreCase("group_spelling_challenge")){
